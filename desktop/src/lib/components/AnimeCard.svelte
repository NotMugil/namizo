...
<div
    class={`group relative flex ${fluid ? "min-w-0 w-full" : "w-32.5 sm:w-40 md:w-50 shrink-0"} flex-col rounded-xl text-inherit no-underline`}
    role="link"
    tabindex="0"
...
>
    ...
    <div
        class="pointer-events-none absolute inset-0 flex translate-y-1.5 flex-col items-center justify-start gap-2 overflow-hidden rounded-xl border border-white/10
